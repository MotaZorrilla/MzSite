...
<head>
    ...
    <style>
        * {
        ...
        html {
            background-color: lime !important; /* Diagnostic color for html element */
        }
        ...
        .reveal .slides section.slide-box .roadmap-item {
            ...
            position: relative !important; /* Needed for absolute positioning of the image */
            overflow: hidden !important; /* Ensures the image doesn't spill out */
        }
        ...
        .section-header h2 {
            ...
            text-shadow: 2px 2px 4px rgba(255, 255, 255, 0.7); /* White shadow */
        }
        ...
        .context-content {
            ...
            position: relative;
            height: 100%; /* Ensure it takes full height of the slide-box */
...
<body>
        ...
        <div class="slides">
            ...
            <section class="slide-box" style="padding: 40px !important;">
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header">
                        <h2>1. El Contexto: ¿Por Qué Planificar Hoy?</h2>
            ...
            <section>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header">
                        <h2>2. La Base: Tu Mapa Financiero</h2>
                        <p>Por Alejandro Jiménez</p>
                    </div>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header">
                        <h2>3. El Motor: La Inversión Inteligente</h2>
                         <p>Por Alejandro Jiménez</p>
                    </div>
                    <div class="roadmap-item" style="flex-grow: 1; display: flex; flex-direction: row !important; padding: 20px; align-items: center;">
                        <div style="width: 50%; padding-right: 20px; text-align: left;">
                ...
                <!-- Slide 2: Interes Compuesto -->
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="roadmap-item" style="flex-grow: 1; display: flex; flex-direction: row !important; padding: 20px; align-items: center;">
                        <div style="width: 50%; padding-right: 20px; text-align: left;">
                            <h3>"La fuerza más poderosa del universo es el interés compuesto."</h3>
                            <p style="text-align: right; margin-right: 15%;">- Atribuida a Albert Einstein</p>
                        ...
                        <div style="width: 50%; height: 100%; position: relative;">
                            <img src="{{ asset('finance/images/compuesto.png') }}" alt="Interés Compuesto" style="width: 100%; height: 100%; object-fit: contain; border-radius: 15px; opacity: 1;">
                        </div>
                    </div>
                </section>
            ...
            <section>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header">
                        <h2>4. La Protección: Tu Red de Seguridad</h2>
                        <p>Por Alejandro Jiménez</p>
                    </div>
                    <div class="roadmap-item" style="flex-grow: 1; display: flex; flex-direction: row !important; padding: 20px; align-items: center;">
                        <div style="width: 50%; padding-right: 20px; text-align: left;">
            ...
            <section>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header">
                        <h2>5. El Futuro Digital: Crypto Essentials</h2>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="section-header" style="margin-bottom: 8px; margin-top: 0; padding-top: 0;">
                        <h2 style="margin-bottom: 8px; margin-top: 0; padding-top: 0;">Precios de Criptomonedas en Vivo</h2>
                    </div>
            ...
            <section>
                ...
                <section class="slide-box" style="padding: 40px !important; display: flex; flex-direction: column;">
                    <div class="roadmap-item" style="flex-grow: 1; display: flex; flex-direction: row !important; padding: 20px; align-items: center;">
                        ...
                        <div style="width: 50%; height: 100%; position: relative;">
                            <img src="{{ asset('finance/images/planAccion.png') }}" alt="Plan de Acción Personalizado" style="width: 100%; height: 100%; object-fit: contain; border-radius: 15px; opacity: 1;">
                        </div>
                    </div>
                </section>
            ...
            <section>
                ...
                <section class="slide-box" style="padding: 40px !important;">
                    ...
                    <div id="crypto-prices" style="color: white; font-size: 1.2em;">Cargando precios...</div>
    ...
    (function() {
        ...
        let gastos = [
            { nombre: 'Café', costo: 2.5, frecuencia: 1, periodo: 'diario' },
            { nombre: 'Cigarrillos', costo: 5, frecuencia: 1, periodo: 'diario' },
            { nombre: 'Snacks', costo: 1.2, frecuencia: 2, periodo: 'diario' },
            { nombre: 'Uber', costo: 4, frecuencia: 1, periodo: 'semanal' }
        ];
        ...
        form.addEventListener('submit', function(e) {
            ...
            gastos.push({ nombre, costo, frecuencia, periodo });
            form.reset();
    ...
    (function() {
        ...
        const history = { btc: [], eth: [], usdt: [] };
        const historyDates = { btc: [], eth: [], usdt: [] };
        // Formato precio
        function fmtPrice(val, symbol) {
            if (symbol === 'usdt') {
                return '$' + val.toLocaleString('en-US', { minimumFractionDigits: 6, maximumFractionDigits: 7 });
            }
            if (val >= 1000) return '$' + val.toLocaleString('en-US', { maximumFractionDigits: 0 });
            return '$' + val.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 5 });
        }
        ...
        function drawSparkline(symbol, data, dates) {
            ...
            const w = 190, h = 90, x0 = 40, y0 = 20, x1 = 230, y1 = 110;
            const n = data.length;
